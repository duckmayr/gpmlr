...
#'  
#' @param mu A vector of latent means for the possible comparisons, as returned by the \code{FMU} slot of a \code{gp} call.
#' @param sigma2 A vector of latent standard deviations for the possible comparison, as returned by the \code{FS2} slot of a \code{gp} call.
#'
